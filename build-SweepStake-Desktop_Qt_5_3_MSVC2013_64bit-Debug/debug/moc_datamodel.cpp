...
#include "../../SweepStake/datamodel.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_DataModel_t, stringdata) + ofs \
...
QT_MOC_LITERAL(6, 49, 9)
    ...
    "DataModel\0getPlayerChanged\0\0addPlayer\0"
    "name\0email\0getPlayer"
};
...
void DataModel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->getPlayerChanged(); break;
        case 1: _t->addPlayer((*reinterpret_cast< QString(*)>(_a[1])),(*reinterpret_cast< QString(*)>(_a[2]))); break;
        default: ;
        }
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&DataModel::getPlayerChanged)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject DataModel::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_DataModel.data,
      qt_meta_data_DataModel,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_DataModel.stringdata))
...
int DataModel::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void *_v = _a[0];
        switch (_id) {
        case 0: *reinterpret_cast< QString*>(_v) = getPlayer(); break;
        default: break;
        }
        _id -= 1;
...
// SIGNAL 0
void DataModel::getPlayerChanged()
{
